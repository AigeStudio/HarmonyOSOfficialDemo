...
class RankPage extends ViewPU {
    ...
    onBackPress() {
        if (this.isShowToast()) {
            prompt.showToast({
                message: { "id": 16777234, "type": 10003, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" },
                duration: TIME
            });
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/RankPage.ets(59:5)");
            Column.backgroundColor({ "id": 16777241, "type": 10001, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" });
    ...
    RankList(widthValue, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/RankPage.ets(83:5)");
            Column.padding({
                left: Style.RANK_PADDING,
                right: Style.RANK_PADDING
            });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            List.create();
            List.debugLine("pages/RankPage.ets(84:7)");
            List.width(WEIGHT);
            ...
            const forEachItemGenFunction = (_item, index) => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("pages/RankPage.ets(87:13)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
