...
export class ListItemComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("view/ListItemComponent.ets(37:5)");
            // 下述代码中的 Row、Column、Text 等都是内置组件，由 SDK 自带提供。
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("view/ListItemComponent.ets(38:7)");
            ...
            if (this.isRenderCircleText()) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("view/ListItemComponent.ets(44:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ListItemComponent.ets(55:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ListItemComponent.ets(60:7)");
    ...
    CircleText(index, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/ListItemComponent.ets(75:5)");
            ...
            Row.backgroundColor({ "id": 16777242, "type": 10001, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" });
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ListItemComponent.ets(76:7)");
            Text.fontWeight(FontWeight.BOLD);
            Text.fontSize(FontSize.SMALL);
