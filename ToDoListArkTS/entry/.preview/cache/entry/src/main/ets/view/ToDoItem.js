...
export default class ToDoItem extends ViewPU {
    ...
    labelIcon(icon, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.width({ "id": 16777226, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Image.height({ "id": 16777226, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Image.margin({ "id": 16777225, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            if (!isInitialRender) {
                Image.pop();
            }
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.backgroundColor({ "id": 16777235, "type": 10001, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Row.width(CommonConstants.LIST_DEFAULT_WIDTH);
            Row.height({ "id": 16777228, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Row.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (this.isComplete) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.labelIcon.bind(this)({ "id": 16777224, "type": 20000, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
                });
            }
            else {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.fontSize({ "id": 16777227, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
